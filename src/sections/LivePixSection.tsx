    ...
    <section id="livepix" className="relative py-20 px-4 sm:px-6 scroll-mt-20">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="relative rounded-xl bg-dark-900 border border-zinc-700/80 p-8 sm:p-12 overflow-hidden shadow-2xl shadow-black"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center">
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <div className="pt-2 grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="flex items-center gap-2 p-2.5 rounded bg-dark-950/70 border border-dark-750 text-zinc-300 text-xs font-mono">
                  <MessageSquare className="w-4 h-4 text-emerald-400 shrink-0" />
                  <span>Mensagem na Live</span>
                </div>
                <div className="flex items-center gap-2 p-2.5 rounded bg-dark-950/70 border border-dark-750 text-zinc-300 text-xs font-mono">
                ...
                <div className="flex items-center gap-2 p-2.5 rounded bg-dark-950/70 border border-dark-750 text-zinc-300 text-xs font-mono">
                  <Heart className="w-4 h-4 text-zinc-300 shrink-0" />
            ...
            {/* Action Column (2/5) */}
            <div className="md:col-span-2 flex flex-col items-center justify-center p-6 rounded-lg bg-dark-950 border border-dark-700 text-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-zinc-400">
                  QR Code e Pix Copia & Cola instantâneo na tela
                </p>
              </div>
              ...
              <Button
                ...
                className="bg-white text-dark-950 hover:bg-zinc-200"
              >
                Apoiar pelo LivePix
              </Button>
